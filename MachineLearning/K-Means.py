...
# Seed for the random algorithm for it to be constant
np.random.seed(0)
...
# Create the k-means. Uses k-means++, which is more powerful, has 4 clusters and will repeat process 12 times
k_means = KMeans(init="k-means++", n_clusters=4, n_init=12)
# Fit the k-means with model
k_means.fit(X)
# Labels the points to the corresponding cluster
k_means_labels = k_means.labels_
print(k_means_labels)
# Get the center of the centroids
